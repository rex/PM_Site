...
<div id="soundcloud" class="hidden reveal-modal large music soundcloud">
	<h2>Pierce Moore - Experiments in Ambience</h2>
	<iframe width="100%" height="450" scrolling="no" frameborder="no" src="http://w.soundcloud.com/player/?url=http%3A%2F%2Fapi.soundcloud.com%2Fplaylists%2F2326323&show_artwork=true"></iframe>
	<a class="close-reveal-modal normal alert button"> </a>
</div>

<div id="mixcloud" class="hidden reveal-modal large music mixcloud">
	<h1>Mixcloud <a href="http://www.mixcloud.com/piercemoore/" class="small round secondary button">My MixCloud Profile</a></h1>

	<h3>Pick a Mix to Listen to</h3>
...
<div id="mixcloud_1" class="hidden reveal-modal large music mixcloud">
	...
	<a href="#" data-reveal-id="mixcloud" class="large button" style="float: left;"><< Back to Mix List</a>
	<a class="close-reveal-modal normal alert button"> </a>
</div>

<div id="mixcloud_2" class="hidden reveal-modal large music mixcloud">
...
<div id="mixcloud_3" class="hidden reveal-modal large music mixcloud">
...
<div id="spotify" class="hidden reveal-modal large music spotify">
...
<div class="row">
	...
	<p class="huge_text" style="text-align:center;">
		I sometimes do music stuff. Give it a listen. 
	</p>

	<div class="eight columns">

		<h1 class="styled">Listen</h1>

		<a href="#" data-reveal-id="soundcloud" class="music_link" alt="Listen to my Music on SoundCloud" title="Listen to my Music on SoundCloud">
			<img src="<?=$url;?>/assets/images/icons/soundcloud_xxl.png" />
		</a>

		<a href="#" data-reveal-id="mixcloud" class="music_link" alt="Listen to my Music on MixCloud" title="Listen to my Music on MixCloud">
			<img src="<?=$url;?>/assets/images/icons/mixcloud_xxl.gif" />
		</a>

		<a href="#" data-reveal-id="spotify" class="music_link" alt="Listen to my Music on Spotify" title="Listen to my Music on Spotify">
			<img src="<?=$url;?>/assets/images/icons/spotify_xxl.png" />
		</a>
	...
	<div class="four columns">
		...
		<h1 class="styled">Purchase</h1>

		<a href="http://itunes.apple.com/us/album/experiments-in-ambience/id551919580?uo=4" class="music_link" alt="Buy my Music on iTunes" title="Buy my Music on iTunes">
